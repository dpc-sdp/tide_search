...
class TideSearchOperation {
  ...
  public function createSearchListingContentType(array $config_location) {
    $configs = [
      ...
      'paragraphs.paragraphs_type.listing_select_from_taxonomy' => 'paragraphs_type',
      ...
      'field.storage.paragraph.field_listing_selected_taxonomy' => 'field_storage_config',
      'field.storage.paragraph.field_user_filter_configuration' => 'field_storage_config',
      'field.storage.paragraph.field_user_filter_input_label' => 'field_storage_config',
      'field.storage.paragraph.field_user_filter_placeholder' => 'field_storage_config',
      ...
      'field.field.paragraph.listing_select_from_taxonomy.field_listing_selected_taxonomy' => 'field_config',
      'field.field.paragraph.listing_select_from_taxonomy.field_user_filter_input_label' => 'field_config',
      'field.field.paragraph.listing_select_from_taxonomy.field_user_filter_placeholder' => 'field_config',
      ...
      'field.storage.node.field_listing_layout_component' => 'field_storage_config',
      'field.storage.node.field_listing_results_component' => 'field_storage_config',
      ...
      'field.field.node.tide_search_listing.field_listing_layout_component' => 'field_config',
      'field.field.node.tide_search_listing.field_listing_results_component' => 'field_config',
      ...
      'core.entity_form_display.paragraph.listing_select_from_taxonomy.default' => 'entity_form_display',
